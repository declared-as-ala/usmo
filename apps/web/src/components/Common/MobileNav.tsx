...
export const MobileNav: React.FC = () => {
  ...
  const moreItems: { screen: typeof activeScreen; label: string; icon: React.ReactNode }[] = [
    { screen: 'football', label: 'Football', icon: <img src="/logo foot.png" alt="" className="h-[22px] w-[22px] rounded-full object-cover" /> },
    { screen: 'basketball', label: 'Basketball', icon: <img src="/logo basket.png" alt="" className="h-[22px] w-[22px] rounded-full object-cover" /> },
