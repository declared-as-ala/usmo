...
const LOCAL_TEAM_LOGOS: Record<string, string> = {
  ...
  'jeunesse sportive omrane': '/teams/jso.png',
  'jeunesse sportive d\'el omrane': '/teams/jso.png',
  'as gabes': '/teams/asm.png',
  'avenir sportif de gabes': '/teams/asm.png',
  'as soliman': '/teams/asm.png',
  'avenir sportif de soliman': '/teams/asm.png',
  'egs gafsa': '/teams/esm.png',
  'us tataouine': '/teams/usbg.png',
