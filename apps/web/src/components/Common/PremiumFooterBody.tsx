...
const TikTokIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64c.298-.002.595.042.88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.04-.1z"/></svg>
);
const YouTubeIcon = () => (
...
export function PremiumFooterBody({ language, year, settings, navigate, install }: Props) {
  ...
  const linkGroups = [
    ...
    },
    {
      ...
      links: [
        [tr(language, 'Official Store', 'Boutique officielle', 'المغازة الرسمية'), 'boutique'],
      ...
      <div className="mx-auto max-w-7xl px-4 pb-7 pt-14 sm:px-6 lg:px-8 lg:pt-16">
        ...
        <div className="flex flex-col gap-5 pt-7 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-wrap gap-x-5 gap-y-2">
            ...
            <Link href="/retours-remboursements" className="hover:text-usm-blue-light">
              {tr(language, 'Returns & Refunds', 'Retours & Remboursements', 'الإرجاع واسترداد الأموال')}
            </Link>
            <Link href="/annulation-commande" className="hover:text-usm-blue-light">
              {tr(language, 'Order Cancellation', 'Annulation de commande', 'إلغاء الطلب')}
            </Link>
