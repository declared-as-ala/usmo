      ...
      <section className="relative min-h-[72vh] overflow-hidden border-b border-usm-border">
        ...
        <div className="relative mx-auto flex min-h-[72vh] max-w-7xl items-end px-4 pb-16 pt-24 sm:px-6 lg:px-8 lg:pb-20">
          <div className="max-w-2xl">
            <span className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#FFD700]/70 bg-gradient-to-r from-[#FFD700]/20 via-[#FFE580]/25 to-[#FFD700]/20 px-4 py-2 text-[10px] font-black uppercase tracking-[0.24em] text-[#FFD700] shadow-[0_4px_24px_rgba(255,215,0,0.35)] backdrop-blur-md [text-shadow:0_1px_6px_rgba(255,215,0,0.5)]"><Crown size={14} className="text-[#FFD700] drop-shadow-[0_1px_4px_rgba(255,215,0,0.6)]" /> {pageContent?.heroBadge || 'Salle des trophées'}</span>
