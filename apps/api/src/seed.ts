...
async function bootstrap() {
  ...
  const sponsors = [
    ...
    },
    {
      ...
      primaryLogo: '/sponsors/azuro/logo.webp',
      lightLogo: '/sponsors/azuro/logo-dark.webp',
      darkLogo: '/sponsors/azuro/logo-dark.webp',
      story: "Partenaire majeur officiel engagé dans le soutien aux activités sportives et au rayonnement de l’USM.",
      storyFr: "Partenaire majeur officiel engagé dans le soutien aux activités sportives et au rayonnement de l’USM.",
      storyAr: 'شريك رئيسي يرافق الاتحاد الرياضي المنستيري وجماهيره بكل شغف.',
      link: 'https://www.facebook.com/azurobrand',
      websiteUrl: 'https://www.facebook.com/azurobrand',
    ...
    },
    {
      ...
      story: "La BIAT est le partenaire financier de l'USM, soutenant les infrastructures du club et les programmes sportifs locaux.",
      storyFr: "La BIAT est le partenaire financier de l'USM, soutenant les infrastructures du club et les programmes sportifs locaux.",
      storyAr: 'بنك بيات هو الشريك المالي للاتحاد، حيث يدعم البنية التحتية للنادي والبرامج الرياضية المحلية.',
      ...
      websiteUrl: 'https://www.biat.com.tn/',
    ...
    },
    {
      ...
      websiteUrl: 'https://www.gat.com.tn/',
      metrics: { impressions: 78000, clicks: 3900, ctr: 5.0 },
    },
    {
      name: 'Maestro',
      slug: 'maestro',
      ...
      link: 'https://www.saida-group.com/nos-marques/28/maestro.html',
      websiteUrl: 'https://www.saida-group.com/nos-marques/28/maestro.html',
      metrics: { impressions: 62000, clicks: 3100, ctr: 5.0 },
    },
    {
      name: 'Saida',
      slug: 'saida',
      ...
      link: 'https://www.saida-group.com/',
      websiteUrl: 'https://www.saida-group.com/',
      metrics: { impressions: 59000, clicks: 2800, ctr: 4.7 },
    },
    {
      name: 'iBrand Tunisia',
      slug: 'ibrand-tunisia',
      ...
      primaryLogo: '/sponsors/ibrand-tunisia/logo.webp',
      lightLogo: '/sponsors/ibrand-tunisia/logo.webp',
      darkLogo: '/sponsors/ibrand-tunisia/logo-dark.webp',
      story: "Partenaire technologique et digital officiel accompagnant la transformation numérique et la visibilité de l’Union Sportive Monastirienne.",
      storyFr: "Partenaire technologique et digital officiel accompagnant la transformation numérique et la visibilité de l’Union Sportive Monastirienne.",
      storyAr: 'الشريك الرقمي والتكنولوجي الرسمي للاتحاد الرياضي المنستيري.',
      offer: 'Profitez de solutions digitales et de services exclusifs avec iBrand Tunisia.',
      offerFr: 'Profitez de solutions digitales et de services exclusifs avec iBrand Tunisia.',
      offerAr: 'استفد من حلول رقمية وخدمات حصرية مع آي براند تونس.',
      link: 'https://ibrandtunisia.tn/',
      websiteUrl: 'https://ibrandtunisia.tn/',
    ...
    },
    {
      ...
      logo: '/sponsors/azuro/logo.webp',
      primaryLogo: '/sponsors/azuro/logo.webp',
      lightLogo: '/sponsors/azuro/logo.webp',
      darkLogo: '/sponsors/azuro/logo-dark.webp',
      story: "Partenaire officiel engagé dans le soutien aux activités sportives et au rayonnement de l’USM.",
      storyFr: "Partenaire officiel engagé dans le soutien aux activités sportives et au rayonnement de l’USM.",
      storyAr: 'شريك رسمي يرافق الاتحاد الرياضي المنستيري وجماهيره بكل شغف.',
      link: 'https://www.facebook.com/azurobrand',
      websiteUrl: 'https://www.facebook.com/azurobrand',
      metrics: { impressions: 45000, clicks: 2100, ctr: 4.6 },
    },
